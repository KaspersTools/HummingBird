...
public:
    ...
    void render() override {
      ...
      for (auto &log : logMessages) {
        switch (log.level) {
          //TODO: /Users/k.debruin/_private/HummingBird/HummingBirdCore/src/UIWindows/LogWindow.h:46:64: warning: format string is not a string literal (potentially insecure) [-Wformat-security]
          // ImGui::TextColored(ImVec4(1.0f, 1.0f, 1.0f, 1.0f), log.message.c_str());

          //                                                               ^~~~~~~~~~~~~~~~~~~
          ///Users/k.debruin/_private/HummingBird/HummingBirdCore/src/UIWindows/LogWindow.h:46:64: note: treat the string as an argument to avoid this
          //            ImGui::TextColored(ImVec4(1.0f, 1.0f, 1.0f, 1.0f), log.message.c_str());
